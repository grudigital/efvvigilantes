        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    echo "<h3>Olá, $row[nome]</h3>";
                    echo "<p>Consulte abaixo seus certificados:</p>";

                    echo "<div style='margin-top:30px' class='row'>";

                    $sqlcertificados = "select * FROM certificados where aluno = '$pegaid'";
                    $resultcertificados = mysqli_query($conn, $sqlcertificados);


                        while ($rowcertificados = mysqli_fetch_assoc($resultcertificados)) {
                            echo "<div class='col-md-3 col-3'>";
                            echo "<a target='_blank' href='admin/uploads/certificados/$rowcertificados[arquivo]'><img width='150px' src='img/download.png'></a>";
                            echo "</div>";
                        }
