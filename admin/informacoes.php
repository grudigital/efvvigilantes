                ...
                <nav class="navbar-custom">
                    ...
                    <ul class="list-inline menu-left mb-0">
                        ...
                        <li class="hide-phone list-inline-item app-search">
                            <h3 class="page-title">Painel de Gerenciamento :: Informações :: Editar</h3>
                        </li>
                    </ul>
                            ...
                            <div class="card m-b-20">
                                <form class="card-body" action="functions/informacoes.php"
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-4">
                                                ...
                                                <p class="text-muted m-b-30 font-14">Editar dados</p>
                                            </div>
                                            <div class="col-6"></div>
                                            <div class="col-2">
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        echo "</div>";
                                        echo "<div class='form-group row'>";
                                        echo "<label for='example-text-input' class='col-sm-2 col-form-label'>Número</label>";
                                        echo "<div class='col-sm-10'>";
                                        ...
                                        echo "</div>";
                                        echo "<div class='form-group row'>";
                                        echo "<label for='example-text-input' class='col-sm-2 col-form-label'>Telefone 1</label>";
                                        echo "<div class='col-sm-10'>";
                                        echo "<input class='form-control' name='telefone1' type='text' value='$row[telefone1]'
                                                   id='example-text-input'>";
                                        echo "</div>";
                                        echo "</div>";
                                        echo "<div class='form-group row'>";
                                        echo "<label for='example-text-input' class='col-sm-2 col-form-label'>Telefone 2</label>";
                                        echo "<div class='col-sm-10'>";
                                        ...
                                        echo "</div>";
                                        echo "<div class='form-group row'>";
                                        echo "<label for='example-text-input' class='col-sm-2 col-form-label'>Telefone 3</label>";
                                        echo "<div class='col-sm-10'>";
                                        echo "<input class='form-control' name='telefone3' type='text' value='$row[telefone3]'
                                                   id='example-text-input'>";
                                        echo "</div>";
                                        echo "</div>";
                                        echo "<div class='form-group row'>";
                                        echo "<label for='example-text-input' class='col-sm-2 col-form-label'>Telefone 4</label>";
                                        echo "<div class='col-sm-10'>";
                                        echo "<input class='form-control' name='telefone4' type='text' value='$row[telefone4]'
                                                   id='example-text-input'>";
                                        echo "</div>";
                                        echo "</div>";
                                    }
